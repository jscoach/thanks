...
const packages = {
  ...
  'defi': 'https://patreon.com/finom',
  'yorkie': 'https://patreon.com/typicode',
  'diogo-cordova-plugin-calendar': 'https://paypal.com/cgi-bin/webscr?cmd=_donations&business=eddyverbruggen%40gmail%2ecom&lc=US&item_name=cordova%2dplugin%2dcalendar&currency_code=EUR&bn=PP%2dDonationsBF%3abtn_donate_SM%2egif%3aNonHosted',
  'react-csv': 'https://paypal.me/AbdennourT/2',
  'react-native-map-clustering': 'https://paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=XN8LRKQRBZJ86',
  'react-fake-props': 'https://patreon.com/typicode',
  'react-native-chatbot': 'https://paypal.com/cgi-bin/webscr?cmd=_donations&business=lucasbr%2edafonseca%40gmail%2ecom&lc=US&item_name=Lucas%20Bassetti&item_number=GitHub&currency_code=USD&bn=PP%2dDonationsBF%3abtn_donateCC_LG%2egif%3aNonHosted',
  'react-simple-chatbot': 'https://paypal.com/cgi-bin/webscr?cmd=_donations&business=lucasbr%2edafonseca%40gmail%2ecom&lc=US&item_name=Lucas%20Bassetti&item_number=GitHub&currency_code=USD&bn=PP%2dDonationsBF%3abtn_donateCC_LG%2egif%3aNonHosted',
  'react-fela': 'https://patreon.com/rofrischmann',
  'fela-plugin-native-media-query': 'https://patreon.com/rofrischmann',
  '@ifiske/cordova-plugin-sms': 'https://paypal.me/dbaq/10',
  'react-native-rename': 'https://paypal.me/junedomingo',
  'html-to-react-components': 'https://patreon.com/bePatron?c=1239559',
  'react-native-circular-menu': 'https://paypal.me/dcergo',
  'cq-prolyfill': 'https://patreon.com/ausi',
  'react-router-ssr': 'https://patreon.com/user?u=4866588',
  'redux-form': 'https://patreon.com/erikras',
  'brainfock': 'https://paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=ZH94NV7E9JU74',
  'structor': 'https://patreon.com/ipselon',
  'react-swipeable-views': 'https://paypal.me/oliviertassinari/10',
  'react-md': 'https://paypal.me/mlaursen03',
  'react-redux-universal-hot-example': 'https://paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=E2LK57ZQ9YRMN',
  'react-scrollchor': 'https://paypal.me/bySabi/10',
  'react-native-simple-dialogs': 'https://patreon.com/douglasjunior',
  'react-native-keyboard-manager': 'https://patreon.com/douglasjunior',
  'react-native-mauron85-background-geolocation': 'https://paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=6GW8FPTE6TV5J',
  'webpack-closure-compiler': 'https://patreon.com/bePatron?c=1239559',
  'coreui.io-react': 'https://paypal.me/holeczek',
  '@ngx-share/button': 'https://patreon.com/bePatron?u=5594898',
  '@ngx-share/buttons': 'https://patreon.com/bePatron?u=5594898',
  '@ngx-share/core': 'https://patreon.com/bePatron?u=5594898',
  '@ahdinosaur/react-fela': 'https://patreon.com/rofrischmann',
  'inline-style-prefixer': 'https://patreon.com/rofrischmann',
  'antlr-builds': 'https://paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=BF92STRXT8F8Q',
  'sass-extras': 'https://patreon.com/sindresorhus',
  'redux-observable': 'https://patreon.com/jayphelps',
  'react-universal-saga-modular': 'https://paypal.me/KawiXiao/3usd',
  'sf-write': 'https://patreon.com/evanyou',
  'ngx-clarity-sharebuttons': 'https://patreon.com/bePatron?u=5594898',
  'react-player': 'https://paypal.me/ckpt',
  'babel-plugin-pipe-composition': 'https://liberapay.com/michaelmitchell/donate',
  'nativescript-vue-template-compiler': 'https://patreon.com/rigor789',
  'material-ui-next-alg': 'https://patreon.com/oliviertassinari',
  'babel-plugin-fela': 'https://patreon.com/rofrischmann',
  'domotz-request-retry': 'https://paypal.me/fgribreau',
  '@transplace/vuetify': 'https://patreon.com/vuetify',
  'fela-native': 'https://patreon.com/rofrischmann',
  'react-native-doc-viewer': 'https://paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=A8YE92K9QM7NA',
  'postcss-bredon': 'https://patreon.com/rofrischmann',
  'material-ui-icons-next': 'https://patreon.com/oliviertassinari',
  'hemera-safe-promises': 'https://patreon.com/starptech',
  'diogo-cordova-plugin-local-notification-2': 'https://paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=L3HKQCD9UA35A ',
  'material-ui': 'https://patreon.com/oliviertassinari',
  'react-native-fingerprint-identify': 'https://paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=5A4DTX8DE85VN',
  'react-native-tableview-simple': 'https://patreon.com/purii',
  'wildfire-dev': 'https://paypal.me/chengkang',
  're-dplayer': 'https://paypal.me/DIYgod',
  'xl-json-server': 'https://patreon.com/typicode'
}
